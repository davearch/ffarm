...
class bnk_widget_twitter extends WP_Widget
{
    ...
    function widget( $args, $instance ) {
        ...
        require("twitter.php");
        ?>
        <div class="bnk-tweets" id="<?php echo $unique_id; ?>">
        <?php bnk_tweets($username, $no_tweets, $consumerkey, $consumersecret, $accesstoken, $accesstokensecret); ?>
        </div><!--END tweets-->
        <?php
        echo $after_widget;
    }
    ...
    function form( $instance ) {
        ...
        <?php _e('Number of tweets:','bhinneka') ?>
        ...
        <?php _e('Consumer Secret: <a href="https://dev.twitter.com/apps" target="_blank">?</a>','bhinneka') ?>
        ...
        <?php _e('Access Token Secret:','bhinneka') ?>
...
function bnk_widget_twitter_init() {
    register_widget("bnk_widget_twitter");
}
add_action('widgets_init','bnk_widget_twitter_init');